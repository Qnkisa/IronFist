...
//index intersection observer coaches
...
//schedule sports script

var sportsFirstDivs = document.querySelectorAll(".sport-first-div");
var sportSecondDivs = document.querySelectorAll(".sport-second-div");

sportsFirstDivs.forEach(element => {
    observer.observe(element);
});

sportSecondDivs.forEach(element => {
    observer.observe(element);
});
